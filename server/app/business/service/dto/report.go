...
type ReportGetPageReq struct {
	...
	Company string `form:"company" search:"type:contains;column:company;table:report" comment:"委托单位"`
	Type string `form:"type" search:"type:exact;column:type;table:report" comment:"查新范围 国内外"`
...
type ReportOrder struct {Id int `form:"idOrder" search:"type:order;column:id;table:report"`
...
type ReportInsertReq struct {
	...
	Type string `json:"type" comment:"查新范围 国内外"`
